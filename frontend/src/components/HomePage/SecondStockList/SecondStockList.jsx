...
import styles from './SecondStockList.module.scss';

const SecondStockList = ({handleSelectStock,selected_stocks, stocks,interested_in}) => {
    return (
...
export default SecondStockList;